...
- Where: `crates/booker-project/src/lib.rs` (`display_path`, with its unit tests), `crates/booker-project/src/content.rs`, `crates/booker-cli/src/lib.rs`. Found by `test (windows-latest)` in the first CI run, https://github.com/can3p/booker/actions/runs/35451247935.
