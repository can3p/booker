...
- ✅ Tutorials 01, 02 and 03 teach all of it. ⬜ Tutorial 02's window steps still need the by-hand walk-through the test cannot do.
- ✅ `docs/WAVE-LOG.md` entry written; the documents in `AGENTS.md` §2 describe the software as it is.
